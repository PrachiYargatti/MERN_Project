          ...
          <ul className="navbar-nav me-auto">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li><Link className="dropdown-item" to="/course/all-courses">Get All Courses</Link></li>
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li><Link className="dropdown-item" to="/admin/Students">Get All Students</Link></li>
              </ul>
            </li>
        </ul>
        </div>
